...
if __name__ == "__main__":
    if sys.argv[5] == 'noinversion':
        y, x = gen_sample(int(sys.argv[2]), float(sys.argv[3]), int(sys.argv[4]))
    else:
        x, y = gen_sample(int(sys.argv[2]), float(sys.argv[3]), int(sys.argv[4])) #take the second argument as the sample size
